...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/admin/kunjungan">
  ...
  <main id="main" class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Daftar Data Dokter</h5>
              <p>Berikut daftar dokter pada Klinik Kesehatan Politala</p>
...
<form action="/admin/tambahdokter" method="post">
  @csrf
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <th><?php echo $value->nama_dokter ?></th>
                    <th><?php echo $value->no_hp ?></th>
                    <th><?php echo $value->password ?></th>
                    <th>
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusModal<?php echo $value->id_dokter ?>">
  Hapus
</button>
<div class="modal fade" id="hapusModal<?php echo $value->id_dokter ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
...
<form action="/admin/hapusdokter" method="post">
  @csrf
      <div class="modal-body">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
        <input type="hidden" value="{{$value->id_dokter}}"name="id_dokter">
