              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <th><?php echo $value->jurusan ?></th>
                    <th><?php echo $value->no_hp ?></th>
                    <th><?php echo $value->keluhan ?></th>
                    <th>
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusModal<?php echo $value->id_kunjungan ?>">
  Hapus
</button>
<div class="modal fade" id="hapusModal<?php echo $value->id_kunjungan ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Kunjungan</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
<form action="/admin/hapuskunjungan" method="post">
  @csrf
      <div class="modal-body">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
        <input type="hidden" value="{{$value->id_kunjungan}}"name="id_kunjungan">
