...
<head>
    <meta charset="utf-8">
    <title>Klinik Kesehatan Politala</title>
...
<body>
        ...
        <div class="row gx-0">
            <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <small class="py-2"><i class="far fa-clock text-primary me-2"></i>Jam Buka: Senin - Jumat : 08.00 - 16.00 | Sabtu & Minggu Tutup </small>
                </div>
            </div>
            <div class="col-md-6 text-center text-lg-end">
                <div class="position-relative d-inline-flex align-items-center bg-primary text-white top-shape px-5">
                    <div class="me-3 pe-3 border-end py-2">
                        <p class="m-0"><i class="fa fa-envelope-open me-2"></i>klinik@politala.ac.id</p>
                    </div>
                    <div class="py-2">
                        <p class="m-0"><i class="fa fa-phone-alt me-2"></i>0811-329-2424</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-3 py-3 py-lg-0">
        ...
        <a href="index.html" class="navbar-brand p-0 d-flex">
            <img src="/assets/img/logo klinik.jpg" width="50px" alt="">
            <h1 class="m-0 text-primary ps-3"> Klinik Kesehatan Politala</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="#pelayanan" class="nav-item nav-link">Layanan Kami</a>
            ...
            <a href="appointment.html" class="btn btn-primary py-2 px-4 ms-3">KONSULTASI</a>
        </div>
    </nav>
    <!-- Navbar End -->
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Solusi Kesehatan untuk Kebutuhan Anda</h1>
                            <a href="appointment.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Konsultasi</a>
                            <!-- <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Kontak Kami</a> -->
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Keep Your Healthy</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Selamat Datang di Klinik Kesehatan Politala</h1>
                            <a href="appointment.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Konsultasi</a>
                            <!-- <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Kontak Kami</a> -->
                        </div>
                    </div>
  ...
  <!--  <div class="container-fluid banner mb-5">
    ...
    <!-- About Start -->
    <div class="container-fluid py-5 wow fadeInUp" id="tentang" data-wow-delay="0.1s">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
    ...
    <!-- Appointment Start -->
   < <div class="container-fluid bg-primary bg-appointment my-5 wow fadeInUp" id="pelayanan" data-wow-delay="0.1s">
        <div class="container">
            <div class="row gx-5">
   ...
   <!-- <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 wow zoomIn" data-wow-delay="0.6s">
                    <div class="offer-text text-center rounded p-5">
                        <h1 class="display-6  text-white">SURVEI KEPUASAN PASIEN</h1>
                        <p class="text-white mb-4">Kami ingin mendengar pengalaman Anda! Survei ini bertujuan untuk meningkatkan pelayanan kami agar sesuai dengan kebutuhan Anda.</p>
                        <a href="appointment.html" class="btn btn-light py-3 px-5 me-3">ISI SURVEY SEKARANG!</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="row g-5">
                <!-- <div class="col-lg-5">
                    <div class="section-title mb-4">
                        <h5 class="position-relative d-inline-block text-primary text-uppercase">List Harga</h5>
                        ...
                        <div class="price-item pb-4">
                            <div class="position-relative">
                                ...
                                <div class="d-flex align-items-center justify-content-center bg-light rounded pt-2 px-3 position-absolute top-100 start-50 translate-middle" style="z-index: 2;">
                                    <h2 class="text-primary m-0">Daftar Harga</h2>
                                </div>
                            </div>
                            <div class="position-relative text-center bg-light border-bottom border-primary py-5 p-4">
                                <h4>Gigi</h4>
                                <hr class="text-primary w-50 mx-auto mt-0">
                                <div class="d-flex justify-content-between mb-3"><span>Scalling</span><i class="fa fa-check text-primary pt-1"></i></div>
                                <div class="d-flex justify-content-between mb-3"><span>Tambal Gigi</span><i class="fa fa-check text-primary pt-1"></i></div>
                                <div class="d-flex justify-content-between mb-2"><span>Cabut Gigi</span><i class="fa fa-check text-primary pt-1"></i></div>
                                <a href="appointment.html" class="btn btn-primary py-2 px-4 position-absolute top-100 start-50 translate-middle">lihat semua</a>
                            </div>
                        </div>
                </div>
                <div class="col-6">
    ...
    <!-- Footer Start -->
    <div class="container-fluid bg-dark text-light py-5 mt-5 wow fadeInUp" id="kontak" data-wow-delay="0.3s" style="margin-top: -75px;">
        <div class="container pt-3">
            <div class="row g-5 pt-1">
                ...
                <div class="col-lg-12 col-md-6 text-center">
                    <h3 class="text-white mb-4">Temukan Kami</h3>
                    <p class="mb-2"><i class="bi bi-geo-alt text-primary me-2"></i> Jl. Ahmad Yani Km. 06, Desa Panggung, Pelaihari, Kalimantan Selatan, Indonesia 70852</p>
                    <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i>klinik@politala.ac.id</p>
                    <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i>0811-329-2424</p>
                </div>
                <!-- <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-white border-bottom" href="#">Klinik Politala</a>. All Rights Reserved.</p>
                </div>
